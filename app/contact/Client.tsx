        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input className="mt-1 w-full rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-slate-100" required />
            </div>
            <div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input type="email" className="mt-1 w-full rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-slate-100" required />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea rows={5} className="mt-1 w-full rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-slate-100" />
          </div>

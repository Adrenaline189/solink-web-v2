...
const ITEMS = [
  { icon: <Lock className="h-5 w-5" />, title: "Encryption", desc: "TLS 1.2+ in transit; envelope encryption at rest." },
  { icon: <FileCheck2 className="h-5 w-5" />, title: "Access Control", desc: "Least-privilege, SSO/SAML (enterprise), audit trails." },
  { icon: <Eye className="h-5 w-5" />, title: "Observability", desc: "Tamper-evident logs, retention policies, alerting." },
  { icon: <Shield className="h-5 w-5" />, title: "Compliance", desc: "GDPR/PDPA aligned data handling; DPA available." },
];
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16">
      <header>
        ...
        <p className="mt-4 max-w-2xl text-slate-300">Our security model prioritizes isolation, visibility, and control.</p>
      </header>
      ...
      <section className="mt-16">
        <SectionTitle title="Documents" subtitle="Security overview and Data Processing Addendum available on request." />
        <div className="grid gap-4 md:grid-cols-2">
          <a href="#" className="block rounded-2xl border border-slate-800 bg-slate-900/40 p-5 hover:bg-slate-900/60">

            ...
            <CardContent className="p-5">
              ...
              <div className="mt-2 flex flex-col sm:flex-row gap-2">
                <input
                  value={refLink}
                  readOnly
                  placeholder={t(lang, "ref.placeholder")}
          ...
          <Card>
            <CardContent className="p-5">
              ...
              <div className="mt-3 flex gap-2">
                <Button className="rounded-xl">{t(lang, "actions.details")}</Button>
                <Button variant="secondary" className="rounded-xl">{t(lang, "actions.retry")}</Button>
              </div>
            </CardContent>
          </Card>
        </div>
  ...
  return (
    <div>
      ...
      <div className="w-full h-2 rounded-full bg-slate-800 overflow-hidden">
        <div className={`h-full bg-gradient-to-r ${color} meter-width-${value}`} />
      </div>
    </div>
  );
}
